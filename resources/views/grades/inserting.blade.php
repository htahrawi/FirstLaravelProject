    ...
    <body>
        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                @endif
                <form action="{{Route('grades.save')}}" method="POST" enctype="multipart/form-data" >
                    @csrf

                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('messages.student name')}}</label>
                        <input type="text" class="form-control" name="name" placeholder="{{__('messages.student name')}}">
                        @error('name')
                    ...
                    <br>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('messages.student image')}}</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="mark" placeholder="{{__('messages.mark')}}">
                        @error('mark')
                            <small class="text-danger form-text">{{$message}}</small>
                        @enderror
                    </div><br>
